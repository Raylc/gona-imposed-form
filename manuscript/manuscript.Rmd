...
Laser-scanning 3DGM studies of LCTs collect vast amounts of shape data but may discard upward of 50% of the observed variation in order to focus on two or three interpretable principal components.
...
Such estimation on have been found to be reasonably accurate when compared to 3D methods, but with the potential for substantial error on individual artifacts [@lin2010].
